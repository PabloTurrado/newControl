# Install script for directory: /home/alex/gitControl/appTeleop
...
FILE(INSTALL DESTINATION "/usr/local/mrcore/bin" TYPE EXECUTABLE FILES "/home/alex/gitControl/appTeleop/teleop")
  IF(EXISTS "$ENV{DESTDIR}/usr/local/mrcore/bin/teleop" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/mrcore/bin/teleop")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/mrcore/bin/teleop")
